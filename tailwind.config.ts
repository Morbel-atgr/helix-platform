  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "highlight-pulse": { "0%": { backgroundColor: "hsl(var(--primary) / 0.2)" }, "30%": { backgroundColor: "hsl(var(--primary) / 0.2)" }, "100%": { backgroundColor: "hsl(var(--primary) / 0)" } },
      },
      animation: {
        ...
        "highlight-pulse": "highlight-pulse 5s cubic-bezier(0.4, 0, 0.2, 1) forwards",
      },
    },
  },
