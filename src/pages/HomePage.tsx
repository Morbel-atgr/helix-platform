...
import { Activity, TrendingUp, GripHorizontal } from 'lucide-react';
    ...
    <div className="space-y-10 animate-slide-up">
      ...
      <div>
        <h2 className="text-base font-semibold text-foreground mb-4 flex items-center gap-2">
          ...
          <HelpTip>Each card shows a life domain's health (0–100) based on upcoming deadlines. Drag to reorder.</HelpTip>
        </h2>
      ...
      {verticals.length > 0 && (
        <div>
          <h2 className="text-base font-semibold text-foreground mb-4 flex items-center gap-2">
            ...
            <HelpTip>Your 5 most pressing tasks across all verticals, ranked by deadline urgency and priority weight.</HelpTip>
          </h2>
